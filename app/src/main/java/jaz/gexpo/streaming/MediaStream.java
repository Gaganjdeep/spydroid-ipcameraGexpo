...
import jaz.gexpo.streaming.rtp.AbstractPacketizer;
...
public abstract class MediaStream implements Stream {
	 ...
	 * {@link VideoStream#setVideoQuality(jaz.gexpo.streaming.video.VideoQuality)}
	 * for a {@link VideoStream} and {@link AudioStream#setAudioQuality(jaz.gexpo.streaming.audio.AudioQuality)}
	...
	/**
	 * Returns the SSRC of the underlying {@link jaz.gexpo.streaming.rtp.RtpSocket}.
	...
	protected void createSockets() throws IOException {
		...
		final String LOCAL_ADDR = "jaz.gexpo.streaming-";

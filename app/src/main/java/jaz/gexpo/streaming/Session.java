...
import jaz.gexpo.streaming.audio.AudioStream;
import jaz.gexpo.streaming.exceptions.CameraInUseException;
import jaz.gexpo.streaming.exceptions.ConfNotSupportedException;
import jaz.gexpo.streaming.exceptions.InvalidSurfaceException;
import jaz.gexpo.streaming.exceptions.StorageUnavailableException;
import jaz.gexpo.streaming.gl.SurfaceView;
import jaz.gexpo.streaming.rtsp.RtspClient;
import jaz.gexpo.streaming.video.VideoQuality;
import jaz.gexpo.streaming.video.VideoStream;
...
public class Session {
	...
	static {
		...
		new HandlerThread("jaz.gexpo.streaming.Session"){
			@Override

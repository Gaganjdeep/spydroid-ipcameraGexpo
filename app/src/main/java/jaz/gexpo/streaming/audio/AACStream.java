...
package jaz.gexpo.streaming.audio;
...
import jaz.gexpo.streaming.rtp.AACADTSPacketizer;
import jaz.gexpo.streaming.rtp.AACLATMPacketizer;
...
public class AACStream extends AudioStream {
	...
	private void testADTS() throws IllegalStateException, IOException {
		...
		final String TESTFILE = Environment.getExternalStorageDirectory().getPath()+"/spycam-test.adts";

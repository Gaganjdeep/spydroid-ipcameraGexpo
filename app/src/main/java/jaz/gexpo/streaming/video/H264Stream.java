...
import jaz.gexpo.streaming.mp4.MP4Config;
import jaz.gexpo.streaming.rtp.H264Packetizer;
...
public class H264Stream extends VideoStream {
	...
	private MP4Config testMediaRecorderAPI() throws RuntimeException, IOException {
		...
		final String TESTFILE = Environment.getExternalStorageDirectory().getPath()+"/spycam-test.mp4";

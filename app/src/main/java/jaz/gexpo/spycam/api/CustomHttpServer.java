...
import jaz.gexpo.streaming.rtsp.UriParser;
 ...
 * <p>
 * Its document root is assets/www, it contains a little user-friendly website to control spycam from a browser.
 * <p>
 ...
 * <p>
 * Streams can also be started/stopped by sending GET request to "/spycam.sdp".
...
public class CustomHttpServer extends TinyHttpServer
{
    ...
    public void onCreate()
    {
        ...
        addRequestHandler("/spycam.sdp*", mDescriptionRequestHandler);
